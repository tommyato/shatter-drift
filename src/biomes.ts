...
const BIOMES: Biome[] = [
  {
    ...
    colors: {
      ...
      fog: 0x050518,
      fogDensity: 0.010,
      obstacleBase: 0x5522aa,
      obstacleEdge: 0xcc77ff,
      obstacleEmissiveIntensity: 0.7,
      orbColor: 0xffcc00,
  ...
  },
  {
    ...
    colors: {
      ...
      obstacleEdge: 0x77ddff,
      obstacleEmissiveIntensity: 0.75,
      orbColor: 0x44ffdd,
